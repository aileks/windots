#!/usr/bin/env zsh
# Cinder Grove
# Based on Ashen by Caspian Harper
...
ZSH_HIGHLIGHT_STYLES[single-quoted-argument]='fg=#E17A3F'
ZSH_HIGHLIGHT_STYLES[double-quoted-argument]='fg=#E17A3F'
ZSH_HIGHLIGHT_STYLES[dollar-quoted-argument]='fg=#E17A3F'
ZSH_HIGHLIGHT_STYLES[rc-quote]='fg=#58918C'
ZSH_HIGHLIGHT_STYLES[dollar-double-quoted-argument]='fg=#E17A3F,bold'
ZSH_HIGHLIGHT_STYLES[back-double-quoted-argument]='fg=#E17A3F,bold'
ZSH_HIGHLIGHT_STYLES[back-dollar-quoted-argument]='fg=#E17A3F,bold'
ZSH_HIGHLIGHT_STYLES[assign]='none'
ZSH_HIGHLIGHT_STYLES[redirection]='fg=#D9A441'
ZSH_HIGHLIGHT_STYLES[comment]='fg=#58534C'
ZSH_HIGHLIGHT_STYLES[named-fd]='none'
ZSH_HIGHLIGHT_STYLES[numeric-fd]='none'
ZSH_HIGHLIGHT_STYLES[arg0]='fg=#E17A3F,bold'
